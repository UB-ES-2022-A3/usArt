...
const termsAndConditions = () => {
    return (
        <div>
            <div className='rounded w-75 justify-items-center shadow align-items-center justify-content-center container pb-5' style={{ backgroundColor: "white" }}>
                <div className='pt-3 pb-5 d-block'>
                    <a href="/home"><BsFillArrowLeftSquareFill size='30' className='mx-3 my-3 shadow' /></a>
                    <h2 className=' align-items-center  text-center' style={{ color: "black", textAlign: "center" }}>  <strong>UsArt Terms of Use</strong> </h2>
                </div>
                ...
                <p>The UsArt website located at azure.website/usArt is a copyrighted work belonging to UsArt. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
                ...
                <p><strong>Cookies and Web Beacons.</strong> Like any other website, UsArt uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
                ...
                <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Gran Via de les Corts Catalanes, 585. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
